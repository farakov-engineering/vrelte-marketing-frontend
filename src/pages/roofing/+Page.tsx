    ...
    <div className="min-h-screen bg-[#FFFDF7] text-[#2A2114]">
          ...
          <div className="grid items-center gap-14 pt-16 lg:grid-cols-2">
            <div>
              <div className="mb-6 inline-block rounded-full bg-[#FFF3D1] px-4 py-2 text-sm text-[#8A6B1F]">
                Set up your roofing lead follow-up in under 10 minutes
              </div>

              <h1 className="text-5xl md:text-6xl font-semibold leading-tight">
                Every roofing lead gets texted instantly and qualified
                automatically
              </h1>

              <p className="mt-6 text-lg text-[#5A4A2A] max-w-xl">
                Built for roofing contractors. The moment someone fills out your
                form, Vrelte texts them, asks the right project questions, and
              ...
              <div className="rounded-2xl border border-[#EFE3C7] bg-white p-5 shadow-lg">
                ...
                <div className="mt-5 grid grid-cols-2 gap-3 text-sm">
                  <div className="bg-[#FAF6EC] p-3 rounded-xl">
                    ...
                    <p className="font-semibold">Possible storm damage</p>
                  </div>
                  <div className="bg-[#FAF6EC] p-3 rounded-xl">
        ...
        <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-[2rem] border border-[#EFE3C7] bg-white p-8 shadow-sm md:p-10">
            ...
            <h2 className="mt-6 text-3xl font-semibold tracking-tight md:text-4xl">
              Roofing leads go cold fast
            </h2>

            <div className="mt-6 space-y-5 text-base leading-8 text-[#5A4A2A]">
              <p>
                Someone fills out your form because they have a leak, storm
                damage, missing shingles, or they need a roof replacement quote.
                If nobody responds quickly, they move on to the next roofer.
              </p>
            ...
            <div className="mt-7 space-y-3">
              {[
                "text back and forth to get the address and roof issue",
                "ask the same project questions on every new inquiry",
                "figure out which leads are serious and which ones are just shopping around",
              ].map((item) => (
                <div
                  key={item}
            ...
            <p className="mt-7 text-base leading-8 text-[#5A4A2A]">
              That is time your office and crew do not have during a busy
              season.
            </p>
          </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl border border-[#F2E6C9] bg-white p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-[#5A4A2A]">
                  The first roofing company to reply often gets the inspection
                  or estimate, especially after storms.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-[#F2E6C9] bg-white p-5 sm:col-span-2">
                ...
                <p className="mt-2 text-sm leading-6 text-[#5A4A2A]">
                  ...
                  inspection and replacement leads wait for a callback.
                </p>
              </div>
              <div className="rounded-3xl border border-[#F2E6C9] bg-white p-5 sm:col-span-2">
                <p className="text-sm font-medium text-[#8A6B1F]">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24 md:px-10 lg:px-12">
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="rounded-[2rem] border border-[#EFE3C7] bg-white p-8 shadow-sm md:p-10">
            ...
            <h2 className="mt-6 text-3xl font-semibold tracking-tight md:text-4xl">
              We handle the first roofing conversation for you
            </h2>
            ...
            <div className="mt-6 space-y-5 text-base leading-8 text-[#5A4A2A]">
              ...
              <p>
                It asks the right roofing intake questions, understands the
                project, and gathers the information your office needs before
                anyone has to step in.
              </p>
              <p className="text-[#3A2E16] font-medium">
                By the time you see the lead, it is already qualified and ready
                for a callback, inspection, or estimate follow-up.
              </p>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  desc: "Leak, storm damage, missing shingles, replacement interest, or inspection request",
                },
                {
                ...
                },
                {
                  ...
                  desc: "Vrelte asks your intake questions and collects the project details",
                },
                {
                  title: "You get a qualified roofing lead",
                  desc: "Structured info ready for your office to call, schedule, or quote",
                },
              ].map((step, i) => (
                <div
                  key={i}
      ...
      >
        <div className="space-y-10">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              {
                title: "Connect your roofing business",
                desc: "Add your website and tell us how you want new roofing and inspection inquiries handled.",
              },
              {
                title: "Choose what info you want collected",
                desc: "Pick the questions that matter - address, issue, storm damage, urgency, insurance involvement, budget, anything you need.",
              },
              {
                title: "Vrelte handles the follow-up",
                desc: "New roofing leads get an immediate text response and arrive with cleaner info for your office or sales team.",
              },
            ].map((step, i) => (
              <div
                key={i}
      ...
      >
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] items-start">
          <div>
            ...
            <h2 className="mt-6 text-3xl font-semibold tracking-tight md:text-4xl">
              A real roofing inquiry becomes a ready-to-use lead
            </h2>
              ...
              <div className="space-y-4 text-sm">
                <div className="flex justify-start">
                  <div className="bg-[#FFF4DA] p-4 rounded-2xl max-w-[80%]">
                    <p className="text-xs text-[#9e7a34] mb-1">Lead</p>I think I
                    have storm damage on my roof
                  </div>
                </div>
                ...
                <div className="flex justify-end">
                  <div className="bg-[#F59E0B] text-white p-4 rounded-2xl max-w-[80%]">
                    <p className="text-xs text-white/70 mb-1">AI</p>
                    Thanks. Is it an active leak, visible damage, or are you
          ...
          <div className="rounded-[2rem] border border-[#EFE3C7] bg-[#FFFCF6] p-6 shadow-sm">
            <div className="mb-6 flex items-center justify-between">
              <div>
                ...
                <p className="font-semibold">Qualified roofing lead</p>
              </div>
            ...
            <div className="space-y-3 text-sm">
              {[
                ...
                { label: "Issue", value: "Possible storm damage" },
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24 md:px-10 lg:px-12">
        <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] items-start">
          <div className="rounded-[2rem] border border-[#EFE3C7] bg-white p-8 shadow-sm md:p-10">
            ...
            <h2 className="mt-6 text-3xl font-semibold tracking-tight md:text-4xl">
              If you run roofing leads, this is built for you
            </h2>
            <p className="mt-6 text-base leading-8 text-[#5A4A2A] max-w-xl">
              Vrelte works best for roofing companies that depend on fast
              follow-up, cleaner intake, and getting inspection and estimate
              requests to the right person quickly.
            </p>
            <div className="mt-8 space-y-3">
              {[
                "Roof leaks and repair inquiries",
                "Storm damage and inspection requests",
                "Replacement estimate leads",
                "After-hours website form submissions",
                "Roofing offices that want cleaner handoff to sales or scheduling",
              ].map((item) => (
                <div
                  key={item}
                  className="flex items-center gap-3 rounded-2xl border border-[#F4E9CF] bg-[#FFFBF2] px-4 py-4"
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              {
                title: "Repair leads",
                desc: "Respond faster when homeowners need help with leaks or visible roof damage",
              },
              {
                title: "Replacement leads",
                desc: "Collect better info before following up on full roof replacement opportunities",
              },
              {
              ...
              },
              {
                ...
                desc: "Reduce repetitive intake work for your office, estimator, or sales team",
              },
            ].map((card) => (
              <div
                key={card.title}
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24 md:px-10 lg:px-12">
        <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] items-start">
          <div className="rounded-[2rem] border border-[#EFE3C7] bg-white p-8 shadow-sm md:p-10">
            <div className="inline-flex rounded-full bg-[#FFF3D1] px-4 py-2 text-sm font-medium text-[#8A6B1F]">
              Why roofing companies use this
            </div>
            <h2 className="mt-6 text-3xl font-semibold tracking-tight md:text-4xl">
              More qualified roofing leads, less wasted office time
            </h2>
            <p className="mt-6 text-base leading-8 text-[#5A4A2A] max-w-xl">
              Instead of manually chasing every inquiry, your team focuses on
              the people who are actually ready to book an inspection or talk
              about a replacement.
            </p>
            <div className="mt-8 space-y-3">
              {[
                "Respond instantly to every new roofing lead",
                "Stop losing after-hours website inquiries",
                "Collect structured project details automatically",
              ...
              {[
                {
                  ...
                  desc: "New roofing leads get contacted in under 60 seconds instead of waiting hours",
                },
                {
                  title: "Higher booking rate",
                  desc: "Following up first helps you win more inspections and estimates",
                },
                {
                ...
                },
                {
                  ...
                  desc: "Your office gets cleaner info before calling back or scheduling",
                },
              ].map((item) => (
                <div
                  key={item.title}
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24 md:px-10 lg:px-12">
        <div className="rounded-[2rem] border border-[#EFE3C7] bg-[#FFFCF6] p-8 shadow-sm md:p-10">
          ...
          <h2 className="mt-6 text-3xl font-semibold tracking-tight md:text-4xl">
            Built to do one roofing job really well
          </h2>
          <p className="mt-6 text-base leading-8 text-[#5A4A2A] max-w-2xl">
            Most roofing companies do not need another bloated platform with
            complicated onboarding and features nobody uses. They need faster
            lead response, better intake, and a cleaner handoff to the office or
            sales team.
          </p>
          ...
          <div className="rounded-[2rem] border border-[#EFE3C7] bg-[#FFFCF6] p-8 md:p-10 max-w-3xl shadow-sm">
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-[#5A4A2A] max-w-md">
                  Full setup, AI text follow-up, roofing lead qualification, and
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2 text-sm">
              {[
                ...
                "AI text qualification for roofing leads",
        ...
        <div className="space-y-10">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-base leading-8 text-[#5A4A2A]">
              Tools that answer, qualify, and route your roofing leads so your
              team stays focused on the jobs.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "New roofing leads get an instant response, answer the intake questions you'd normally ask, and land in your office as a clean, ready-to-call summary.",
              },
              {
                label: "Building next",
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24 md:px-10 lg:px-12">
        <div className="rounded-[2rem] border border-[#EFE3C7] bg-[#FFFCF6] px-8 py-12 text-center shadow-sm md:px-12">
          <h2 className="text-3xl font-semibold tracking-tight md:text-4xl">
            Want to see it on real roofing leads?
          </h2>
          ...
          <div className="grid gap-10 md:grid-cols-3">
            <div>
              ...
              <p className="mt-4 max-w-sm text-sm text-[#5A4A2A]">
                Vrelte helps roofing companies instantly respond to inbound
                leads, qualify them automatically, and focus on real inspection,
