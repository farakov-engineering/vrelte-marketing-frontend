            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-[#5A4A2A] max-w-md">
                  ...
                  and ongoing support are all included while we prove the value.
                </p>
              </div>
        ...
        <div className="space-y-10">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-base leading-8 text-[#5A4A2A]">
              Tools that answer, qualify, and route your plumbing leads so your
            ...
            {[
              {
                ...
                desc: "New plumbing leads get an instant response, answer the intake questions you'd normally ask, and land in your office as a clean, ready-to-call summary.",
              },
              {
                label: "Building next",
