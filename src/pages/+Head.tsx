export default function Head() {
  ...
  const description =
    "Stop losing jobs to whoever answered first. Vrelte instantly texts your leads, qualifies them, and delivers ready-to-book customers. Built for contractors and service businesses.";
